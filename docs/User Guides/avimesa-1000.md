...
---
![avimesa-1000](https://raw.githubusercontent.com/Avimesa/user-guide-avimesa-1000/master/images/avimesa-1000-perspective.png)
...
![ug-callouts](https://raw.githubusercontent.com/Avimesa/user-guide-avimesa-1000/master/images/ug-callouts.png)
...
The following assumes that the Avimesa Gateway is configured and running. Please see [here](/avimesa-gateway-for-raspberry-pi-user-guide/) for help on setting up the Avimesa Gateway.
...
After boot up, the normal state of the device is `Run Mode`. In the mode, the device will perform measurements and synchronize with Avimesa Messages based upon it's configuration. The configuration is setup via the Avimesa Toolkit and is described [here](#8.-device-config).
...
![ug-callouts](https://raw.githubusercontent.com/Avimesa/user-guide-avimesa-1000/master/images/ug-led-states-led-test.png)
...
![ug-callouts](https://raw.githubusercontent.com/Avimesa/user-guide-avimesa-1000/master/images/ug-led-states-run-mode.png)
...
![ug-callouts](https://raw.githubusercontent.com/Avimesa/user-guide-avimesa-1000/master/images/ug-led-states-service-mode.png)
...
![ug-callouts](https://raw.githubusercontent.com/Avimesa/user-guide-avimesa-1000/master/images/ug-led-states-fw-update-mode.png)
...
The device is configured using the functionality exposed by the Avimesa API. An example application, the Avimesa Toolkit ([https://toolkit.avimesa.com](https://toolkit.avimesa.com)), is available to be used for this and is located at [https://github.com/Avimesa/toolkit-nodejs](https://github.com/Avimesa/toolkit-nodejs)
